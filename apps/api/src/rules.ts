...
import { evaluateAndPersistUserRules } from '@atlas/portfolio-core';
import { loadConsolidatedInputs } from '@atlas/dataplane';
import { audit, requireUser } from './auth.js';
import { problem } from './http.js';

// The rule-evaluation write path is shared with the background workers, so it
// lives in @atlas/portfolio-core rather than here (§27.4). Re-exported for
// backwards compatibility with existing importers.
export { evaluateAndPersistUserRules };
