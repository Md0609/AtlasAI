...
import { loadEngineInputs, type Db } from '@atlas/dataplane';
import { requireUser } from './auth.js';
import { problem } from './http.js';
import { ownedPortfolio } from './portfolios.js';

// Input loading moved to @atlas/dataplane in Phase 4b (shared with the
// intelligence plane). Re-exported here so existing api imports and
// @atlas/api/internal keep resolving unchanged.
export { loadEngineInputs, loadConsolidatedInputs, type Db } from '@atlas/dataplane';
